...
const coreComponents = [
  {
    ...
    description:
      "A structured training and skill development program designed to enhance the capabilities of Neeti Sahayak Kendra (NSK) fellows.",
    color: "text-brand-blue dark:text-blue-400",
    highlights: [
  ...
  },
  {
    ...
    description:
      "A comprehensive learning pathway offering both general and referral courses in the Public Policy domain.",
    color: "text-brand-orange dark:text-orange-400",
    highlights: [
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="font-sans text-xl lg:text-2xl text-gray-200 dark:text-gray-300 leading-relaxed max-w-4xl mx-auto">
                Our flagship capacity-building initiative for building policy
                literacy, professional skills, and career opportunities in
                public policy
              </p>
            </div>
          </div>
              ...
              {features.map((feature, index) => (
                ...
                >
                  <CardHeader className="pb-4">
                    <div
                      className={`inline-flex items-center justify-center w-16 h-16 rounded-full ${feature.bgColor} mx-auto mb-4`}
                    >
                ...
                >
                  <CardHeader className="pb-4">
                    <div className="flex items-center space-x-4 mb-4">
                      <div
                        className={`w-12 h-12 rounded-lg bg-gray-100 dark:bg-slate-700 flex items-center justify-center`}
                      >
                        <component.icon
                      ...
                      <ul className="space-y-2">
                        {component.highlights.map((highlight, idx) => (
                          <li key={idx} className="flex items-center space-x-2">
                            <CheckCircle2
                              className={`w-4 h-4 ${component.color} flex-shrink-0`}
                            />
            ...
            <div className="bg-gradient-to-br from-brand-blue/10 to-brand-orange/10 dark:from-brand-blue/20 dark:to-brand-orange/20 rounded-2xl p-8 lg:p-12">
              <div className="text-center mb-12">
                ...
                <p className="font-sans text-lg text-gray-600 dark:text-gray-300 leading-relaxed max-w-3xl mx-auto">
                  Youth are trained, certified, and placed as citizen
                  consultants, helping communities navigate government schemes
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                {[
                  ...
                  },
                  {
                    ...
                    description: "Direct pathway to policy careers",
                  },
                  {
                    title: "Community Impact",
                    description: "Make a real difference in society",
                  },
                  {
                    title: "Skill Development",
                    description: "Comprehensive capacity building",
                  },
                ].map((benefit, index) => (
        ...
        <section className="py-16 lg:py-24 bg-gradient-to-br from-brand-blue via-slate-800 to-brand-orange text-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="font-sans text-lg lg:text-xl text-gray-200 dark:text-gray-300 leading-relaxed mb-8">
              Join Neeti Kaushal and become a certified policy professional
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              >
                ...
                variant="outline"
                size="lg"
                className="font-sans border-white/80 text-brand-blue hover:bg-white hover:text-brand-blue hover:border-white transition-all duration-300 px-8 py-3 text-lg font-semibold"
              >
                <Link href="/courses">
